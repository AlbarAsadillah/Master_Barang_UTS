...
unset($__errorArgs, $__bag); ?>" type="text" name="kode" id="kode" value="<?php echo e(old('kode')); ?>" placeholder="Masukkan Kode barang">
...
unset($__errorArgs, $__bag); ?>" type="text" name="nama" id="nama" value="<?php echo e(old('nama')); ?>" placeholder="Masukkan Nama Barang">
...
unset($__errorArgs, $__bag); ?>" type="text" name="harga" id="harga" value="<?php echo e(old('harga')); ?>" placeholder="Masukkan Harga Barang">
...
unset($__errorArgs, $__bag); ?>" type="text" name="deskripsi" id="deskripsi" value="<?php echo e(old('deskripsi')); ?>" placeholder="Masukkan Deskripsi Barang">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="satuan" id="position" class="form-select">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row">
                        ...
                        <button type="submit" class="btn btn-success btn-lg mt-3 placeholder-wave "><i class="bi-check-circle me-2" ></i> Input</button>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ALBAR\Mata Kuliah\Framework\UTS\masterBarangUts\resources\views/barang/create.blade.php ENDPATH**/ ?>