...
<body class="bg-dark">
    <div class="container text-center mt-5 py-2 px-4 bg-light rounded-3 border">
                ...
                <div id="carouselExampleCaptions" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="{{ Vite::asset('resources/images/list.png') }}" class="d-block w-100" alt="...">
                      ...
                      <div class="carousel-item">
                        <img src="{{ Vite::asset('resources/images/input.png') }}" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                      ...
                      <div class="carousel-item">
                        <img src="{{ Vite::asset('resources/images/edit.png') }}" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
        ...
        <div class="mt-4">
            <a href="{{route('barang.index') }}" class="btn btn-dark placeholder-wave">List Barang</a>
        </div>
